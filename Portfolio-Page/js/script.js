...
// The Leaflet map, targeting #mapid
document.addEventListener("DOMContentLoaded", function() {
  var mymap = L.map('mapid').setView([46.955062208419804, 7.490954717791388], 13); 
  ...
  var marker = L.marker([46.955062208419804, 7.490954717791388]).addTo(mymap);
